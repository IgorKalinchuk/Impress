...
impress.ASCII_BRACE = 123;

impress.CORE_PLUGINS = [
  'log', 'cache', 'application',
  'client', 'index', 'files', 'templating', 'preprocess',
  'security', 'state', 'cloud',
  'sse', 'websocket', 'jstp', 'rpc', 'health', 'waf'
];
...
impress.HANDLER_TYPES = {
  ...
  ws: 'WebSocket',
  rpc: 'Impress RPC',
  jstp: 'JSTP over WebSocket'
};

impress.COOKIES_EXPIRES = '=deleted; Expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/; Domain=';
...
impress.DEFAULT_API = [
  ...
  'stream', 'buffer', 'domain', 'crypto', 'events',
  'punycode', 'readline', 'querystring', 'timers',

  // Impress API modules
  'db', 'con', 'common', 'impress', 'registry', 'definition',

  // Preinstalled modules
  'csv', 'async', 'iconv', 'colors',
